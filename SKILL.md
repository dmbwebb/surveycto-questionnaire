...
description: Expert guidance for creating and editing XLSForm surveys, questionnaires, and forms in Excel format for mobile data collection platforms (SurveyCTO, ODK, KoboToolbox). Use this skill when Claude needs to: (1) Create new surveys or questionnaires in Excel (.xlsx), (2) Edit or modify existing survey forms, (3) Add skip logic, calculations, or constraints, (4) Debug XLSForm syntax errors or validation issues, (5) Design repeating groups or multi-language surveys, (6) Implement survey design best practices, (7) Work with survey/choices/settings sheets, (8) Read or analyze survey/questionnaire files, (9) Manipulate XLSForm Excel files programmatically, (10) Convert surveys to human-readable text format, or (11) Upload/replace a form definition on a SurveyCTO server from the CLI (no browser, no file picker). Triggers: "survey", "questionnaire", "SurveyCTO", "XLSForm", "ODK", "KoboToolbox", "survey form", "baseline survey", "endline survey", "skip logic", "relevance condition", "choice list", "upload form", "deploy form", "push form".
---
